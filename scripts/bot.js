...
module.exports.onChat = async ({ message, event }) => {
  const hh = event.text?.toLowerCase() || "Bot";
  if (hh.startsWith("bot") || hh.startsWith("বট")) {
    try {
      const ar = [
      ...
      "Bolo Babu, তুমি কি আমাকে ভালোবাসো? 🙈💋 ",
       ...
       "bado maser kawwa police amar sawwa😞",
        ...
        "𝗲𝘁𝗼 বট বট 𝗻𝗮 𝗸𝗼𝗿𝗲 𝘁𝗮𝗸𝗮 𝗼 𝘁𝗼 𝗽𝗮𝘁𝗵𝗮𝘁𝗲 𝗽𝗮𝗿𝗼😒🥳🥳 ",
      ...
      "Chup kor nunu kete demu bashi dakle😬",
        ...
        "আম গাছে আম নাই ঢিল কেন মারো, তোমার সাথে প্রেম নাই বট কেন ডাকো🥲 ",
